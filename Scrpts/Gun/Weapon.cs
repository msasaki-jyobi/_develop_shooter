...
namespace develop_shooter
{
    public class Weapon : WeaponBehaviour
    {
        ...
        [SerializeField] private Magazine _gunMagaize;
        ...
        public void ChangeFireLate(int minutes, int impulse, int ammuntion)
        {
            roundsPerMinutes = minutes; // 発射レート（高いほど連射）
            projectileImpulse = impulse; // 軽さ（低いと落下）
            
            ammunitionCurrent = ammuntion; // 現在の弾数
            _gunMagaize.ChangeTotalMagazine(ammuntion); // 装弾数
        }
    }
}